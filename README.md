...
**Data Engineer · DevOps · Solo**  
Семён · seller.ru AI&ML · Екатеринбург

Строю DWH, пишу ETL, поднимаю сервера, автоматизирую всё.  
В команде я один — закрываю и данные, и devops, и архитектуру.
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Сервера-сам-F59E0B?style=flat-square"/>
  <img src="https://img.shields.io/badge/AI-советчик-22C55E?style=flat-square"/>
  <img src="https://img.shields.io/badge/Сборка-пиздатая-EF4444?style=flat-square"/>
</p>
