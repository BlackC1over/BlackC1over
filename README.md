...
Парсинг любой сложности, работа с API, автоматизированные воркеры.  
...
Использую современные AI-инструменты в работе. Понимаю пайплайны разработки и безопасность — AI ускоряет, но не пишет за меня.
